 ...
 * Update date:2015.7.18
 */

package com.evan2048.evanpano;
...
public class MainActivity extends Activity implements OnClickListener {
	...
	//Environment
	private static final String TAG = "EvanPanoMainActivity";  //debug TAG
    private final String DOWNLOAD_IMAGE_DIRECTORY = "EvanPano";  //download images from air cache directroy(use in downloadAllSelectedFiles function)
	private final String STITCHING_SOURCE_IMAGES_DIRECTORY = Environment.getExternalStorageDirectory().getPath()+"/EvanPano/";  //path:/storage/emulated/0/OpenCV_Panorama_Images/
	private final String STITCHING_RESULT_IMAGES_DIRECTORY = Environment.getExternalStorageDirectory().getPath()+"/EvanPano/result/";  //path:/storage/emulated/0/OpenCV_Panorama_Images/result/
