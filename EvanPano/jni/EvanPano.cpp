...
{
//testjni
JNIEXPORT jstring JNICALL Java_com_evan2048_evanpano_MainActivity_testjni(JNIEnv *env, jobject obj);
//OpenCV Stitching(return:0-success,other-error)
JNIEXPORT jint JNICALL Java_com_evan2048_evanpano_MainActivity_jnistitching(JNIEnv *env, jobject obj, jobjectArray source, jstring result, jdouble scale);
}
